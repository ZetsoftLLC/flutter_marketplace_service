...
class ShopsResponse {
  ...
  factory ShopsResponse.fromJson(String str) =>
      ShopsResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ShopsResponse.fromMap(Map<String, dynamic> json) => ShopsResponse(
